...
$graph->title->Set("Light Levels and Temperature - " . date("G:i, F j", $uts_e) . " to " . date("G:i, F j", $uts_now));
...
$lineplot->SetLegend ("Exp. Temp / C");
$lineplot2->SetLegend("Light / lx");
$lineplot3->SetLegend("Shlt. Temp / C");
